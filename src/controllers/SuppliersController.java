    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == views.btn_register_supplier) {
            ...
            if (views.txt_supplier_name.getText().equals("")
                    ...
                    || views.txt_supplier_telephone.getText().equals(e)
                ...
                if (supplierDao.registerSupplierQuery(supplier)) {
                    ...
                    JOptionPane.showMessageDialog(null, "Ha ocurrido al registrar al proveedor");
                }
            }
            ...
            if (row == -1) {
                ...
                int question = JOptionPane.showConfirmDialog(null, "Desea eliminar este proveedor");
