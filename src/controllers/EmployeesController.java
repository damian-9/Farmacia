...
public class EmployeesController implements ActionListener, MouseListener, KeyListener{
    ...
    public void actionPerformed(ActionEvent e) {
        if(e.getSource() == views.btn_register_employee){
            ...
            if(views.txt_employee_id.getText().equals("")){
                JOptionPane.showMessageDialog(null, "Selecciona un empleado para modificar");
            }else{
                //verificar si los campos estan vacios
                if(views.txt_employee_id.getText().equals("")
                        || views.txt_employee_fullname.getText().equals("")
                    ...
                    if(employeeDao.updateEmployeeQuery(employee)){
                        ...
                        JOptionPane.showMessageDialog(null, "Datos del empleado modificado con éxito");
                    }else{
            ...
            if(row == -1){
                JOptionPane.showMessageDialog(null, "Debes seleccionar un empleado para elimianr");
                ...
                int question = JOptionPane.showConfirmDialog(null, "¿Desea eliminar a este empleado?");
            ...
            if(!password.equals("") && !confirm_password.equals("")){
                ...
                if(password.equals(confirm_password)){
                    ...
                    if(employeeDao.updateEmployeePassword(employee) != false){
                        ...
                        JOptionPane.showMessageDialog(null, "Contaseña modificada con éxito");
                    }else{
