    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == views.btn_register_category) {
            ...
            if (views.txt_category_id.getText().equals("")) {
                JOptionPane.showMessageDialog(null, "Selecciona una categoria para continuar");
            } else {
                if (views.txt_category_id.getText().equals("")
            ...
            if(row == -1){
                ...
                int question = JOptionPane.showConfirmDialog(null, "¿Desea eliminar esta categoría?");
