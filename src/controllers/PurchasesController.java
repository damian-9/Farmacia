...
public class PurchasesController implements KeyListener, ActionListener, MouseListener {
        ...
        if (e.getSource() == views.btn_add_product_to_buy) {
            ...
            if (getIdSupplier == 0) {
                ...
                if (getIdSupplier != supplier_id) {
                    JOptionPane.showMessageDialog(null, "NO puede realizar una misma compra a varios provedores");
                } else {
    ...
    private void insertPurchase() {
        ...
        int employe_id = id_user;

        if (purchaseDao.registerPurchaseQuery(getIdSupplier, employe_id, total)) {
            ...
            cleanTableTemp();
            cleanFieldsPurchases();
            JOptionPane.showMessageDialog(null, "Compra generada con éxtio");
