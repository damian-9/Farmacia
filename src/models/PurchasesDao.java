...
public class PurchasesDao {
    ...
    //Metodo obtener id de la compra
    ...
    //Metodo listar todas las compras registradas
    ...
    public List listPurchasesDetailQuery(int id){
        ...
        String query = "SELECT pu.created, pude.purchase_price, pude.purchase_amount, pude.purchase_subtotal, su.name AS supplier_name, pro.name AS product_name, \n" +
                        "em.full_name FROM purchases pu INNER JOIN purchase_details pude ON pu.id = pude.purchase_id INNER JOIN products pro ON pude.product_id = pro.id\n" +
                        "INNER JOIN suppliers su ON pu.supplier_id = su.id INNER JOIN employees em ON pu.employee_id = em.id WHERE pu.id = ?";
