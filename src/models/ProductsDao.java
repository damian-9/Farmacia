...
public class ProductsDao {
    ...
    ResultSet rs;  //Almacena los datos que se obtuvieron al ejecutar la consulta
    ...
    public boolean deleteProductQuery(int id){
        ...
        try{
            ...
            JOptionPane.showMessageDialog(null,"No puede eliminar un producto que tiene relación con otra tabla");
            return false;
        }
    }
    
    //Metodo de buscar product
    ...
    //Metodo de buscar producto por codigo
    ...
    //Metodo traer la cantidad de productos
